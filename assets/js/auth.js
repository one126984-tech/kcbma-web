...
// 1. Supabase 초기화 설정
// (주의: HTML 파일의 <head>
<meta name="google" content="notranslate" /> 태그 안에 반드시 아래 스크립트가 있어야 합니다.)
            ...
            <div class="modal-backdrop" id="modal-login" role="dialog" aria-modal="true" aria-label="로그인">
                <div class="modal-dialog !max-w-[400px] !p-8">
                    ...
                    <div class="flex flex-col gap-3">
                     <button onclick="socialLogin('google')" type="button" class="flex justify-center items-center h-[52px] rounded-lg bg-blue-50 font-bold text-[15px] text-blue-900 border border-blue-200 hover:bg-blue-100 transition shadow-sm">
